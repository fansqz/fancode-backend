...
func initApp() (*http.Server, error) {
	...
	controllerController := controller.NewController(problemBankManagementController, problemManagementController, sysApiController, sysMenuController, sysRoleController, sysUserController, judgeController, problemController, submissionController, accountController, authController)
