...
func initApp(appConfig *config.AppConfig) (*http.Server, error) {
	...
	debugService := service.NewDebugService(appConfig, judgeService, wsService)
	wsController := controller.NewWsController(debugService, wsService)
	controllerController := controller.NewController(problemBankManagementController, problemManagementController, problemCaseManagementController, sysApiController, sysMenuController, sysRoleController, sysUserController, judgeController, problemController, problemBankController, submissionController, accountController, authController, wsController)
