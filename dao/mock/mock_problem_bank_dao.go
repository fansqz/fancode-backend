...
// GetAllProblemBank mocks base method.
func (m *MockProblemBankDao) GetAllProblemBank(db *gorm.DB) ([]*po.ProblemBank, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAllProblemBank", db)
	ret0, _ := ret[0].([]*po.ProblemBank)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetAllProblemBank indicates an expected call of GetAllProblemBank.
func (mr *MockProblemBankDaoMockRecorder) GetAllProblemBank(db interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllProblemBank", reflect.TypeOf((*MockProblemBankDao)(nil).GetAllProblemBank), db)
}
